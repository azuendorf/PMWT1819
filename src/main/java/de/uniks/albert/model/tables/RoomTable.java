...
public class RoomTable  
{
   ...
   public RoomTable(Room... start)
   {
      this.setColumnName("Room");
      columnMap.put(this.getColumnName(), 0);
      for (Room current : start)
      {
   ...
   public RoomTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public RoomTable setColumnName(String value)
   {
   ...
   public RoomTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandRoomNo(String... rowName)
   {
      ...
      {
         Room start = (Room) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getRoomNo());
         this.table.add(newRow);
      }
      return result;
   }

   public StringTable expandTopic(String... rowName)
   {
      StringTable result = new StringTable();
      result.setColumnMap(this.columnMap);
      result.setTable(this.table);
   ...
   public doubleTable expandCredits(String... rowName)
   {
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Room start = (Room) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getCredits());
         this.table.add(newRow);
      }
      return result;
   }

   public UniversityTable expandUni(String... rowName)
   {
      UniversityTable result = new UniversityTable();
      result.setColumnMap(this.columnMap);
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Room start = (Room) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getUni());
         this.table.add(newRow);
      }
      return result;
   }

   public RoomTable hasUni(UniversityTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         Room start = (Room) row.get(columnMap.get(this.getColumnName()));
         University other = (University) row.get(columnMap.get(rowName.getColumnName()));
         if (start.getUni() == other)
         {
            this.table.add(row);
         }
      }
   ...
   public RoomTable hasStudents(StudentTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public AssignmentTable expandAssignments(String... rowName)
   {
      ...
      {
         Room start = (Room) row.get(columnMap.get(this.getColumnName()));
         for (Assignment current : start.getAssignments())
         {
            ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
            newRow.add(current);
            this.table.add(newRow);
   ...
   public RoomTable hasAssignments(AssignmentTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         ...
         if (start.getAssignments().contains(other))
         {
            this.table.add(row);
         }
      }
   ...
   public RoomTable selectColumns(String... columnNames)
   {
   ...
   public RoomTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public RoomTable filter(Predicate< Room > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public RoomTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Room > toSet()
   {
      LinkedHashSet< Room > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Room value = (Room) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
