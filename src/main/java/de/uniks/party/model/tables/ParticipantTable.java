...
public class ParticipantTable 
{
   ...
   public ParticipantTable(Participant... start)
   {
      this.setColumnName("Participant");
      columnMap.put(this.getColumnName(), 0);
      for (Participant current : start)
      {
   ...
   public ParticipantTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public ParticipantTable setColumnName(String value)
   {
   ...
   public ParticipantTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandName(String... rowName)
   {
      ...
      {
         Participant start = (Participant) row.get(columnMap.get(this.getColumnName()));
   ...
   public doubleTable expandSaldo(String... rowName)
   {
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Participant start = (Participant) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getSaldo());
         this.table.add(newRow);
      }
      return result;
   }

   public PartyTable expandParty(String... rowName)
   {
      PartyTable result = new PartyTable();
      result.setColumnMap(this.columnMap);
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Participant start = (Participant) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getParty());
         this.table.add(newRow);
      }
      return result;
   }

   public ParticipantTable hasParty(PartyTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         Participant start = (Participant) row.get(columnMap.get(this.getColumnName()));
         Party other = (Party) row.get(columnMap.get(rowName.getColumnName()));
         if (start.getParty() == other)
         {
            this.table.add(row);
         }
      }
   ...
   public ShoppingItemTable expandItems(String... rowName)
   {
      ...
      {
         Participant start = (Participant) row.get(columnMap.get(this.getColumnName()));
         for (ShoppingItem current : start.getItems())
         {
            ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
            newRow.add(current);
            this.table.add(newRow);
   ...
   public ParticipantTable hasItems(ShoppingItemTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         ...
         if (start.getItems().contains(other))
         {
            this.table.add(row);
         }
      }
   ...
   public ParticipantTable selectColumns(String... columnNames)
   {
   ...
   public ParticipantTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public ParticipantTable filter(Predicate< Participant > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ParticipantTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Participant > toSet()
   {
      LinkedHashSet< Participant > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Participant value = (Participant) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
